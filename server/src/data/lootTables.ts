...
export const LootTables: Record<string, Record<string, LootTable>> = {
    normal: {
        ...
        guns: [
            { item: "g19", weight: 1.77 },
            { item: "m1895", weight: 1.72 },
            { item: "mp40", weight: 1.7 },
            { item: "mp5", weight: 1.6 },
            { item: "saf200", weight: 1.5 },
            { item: "cz75a", weight: 1.4 },
            { item: "hp18", weight: 1.2 },
            { item: "micro_uzi", weight: 1 },
            { item: "ak47", weight: 1 },
            { item: "model_37", weight: 0.99 },
            { item: "mp5e", weight: 0.7 },
            { item: "aug", weight: 0.7 },
            { item: "sks", weight: 0.7 },
        ...
        special_guns: [
            ...
            { item: "blr", weight: 0.07 },
            { item: "mg36", weight: 0.06 },
            { item: "m3k", weight: 0.06 },
            { item: "sr25", weight: 0.05 },
            { item: "mini14", weight: 0.05 },
            { item: "mcx_spear", weight: 0.05 },
            { item: "an94", weight: 0.05 },
            { item: "vepr12", weight: 0.04 },
            { item: "super90", weight: 0.03 },
        ...
        //Originals
        apple:[
            [{item:NullString,weight:6},{table:"fall_perks",weight:0.3},{item:"apple_helmet",weight:0.3},{item:"apple_launcher",weight:0.2}],
        ]
    },

    halloween: {
        ground_loot: [
            { table: "guns", weight: 1.1 },
            { table: "healing_items", weight: 1 },
            { table: "ammo", weight: 1 },
        ...
        regular_crate: [
            { table: "guns", weight: 1.4 },
            { table: "equipment", weight: 0.7 },
            { table: "healing_items", weight: 0.7 },
            { table: "ammo", weight: 0.5 },
            { table: "scopes", weight: 0.3 },
        ...
        ammo_crate: [
            ...
            [
                ...
                { item: "338lap", count: 6, weight: 0.23 },
                { item: "curadell", weight: 0.1 }
            ]
        ],
        loot_tree: [
        ...
        airdrop_scopes: [
            ...
            { item: "15x_scope", weight: 0.4 },
            { item: "20x_scope", weight: 0.1 }
        ],
        airdrop_melee: [
            { item: NullString, weight: 1 },
    ...
    fall: {
        ...
        airdrop_crate: [
            ...
            [
                { item: "frag_grenade", count: 3, weight: 2 },
                { item: "mirv_grenade", count: 2, weight: .7 },
                { item: NullString, weight: 1 }
            ]
        ],
        gold_airdrop_crate: [
        ...
        airdrop_scopes: [
            { item: "8x_scope", weight: 1 },
            { item: "15x_scope", weight: 0.3 },
            { item: "20x_scope", weight: 0.09 },
        ],
        airdrop_melee: [
            { item: NullString, weight: 1 },
            { item: "hatchet", weight: 0.2 },
        ...
        throwables: [
            { item: "frag_grenade", count: 2, weight: 1 },
            { item: "smoke_grenade", count: 2, weight: 1 },
            { item: "mirv_grenade", count: 2, weight: 1 },
        ],
        equipment: [
            { item: "regular_helmet", weight: 1 },
            { item: "tactical_helmet", weight: 0.2 },
